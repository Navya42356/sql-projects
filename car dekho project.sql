...
----- the manager asked the employee to find how many cars will be available in 2023-----
select count(*) from car_dekho where year = '2023';
----- the manager asked the empoyee to find how many cars available in 2020,2021,2022-----
...
------ manager asked the employee to give complete details of all cars between 2015 and 2023
